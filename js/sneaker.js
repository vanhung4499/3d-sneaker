...
export class Sneaker {
    ...
    constructor(scene) {
        ...
        this.swooshRightGroup = new AnimationGroup('swooshRightAnimationGroup')
        this.swooshLeftGroup = new AnimationGroup('swooshLeftAnimationGroup')
        this.soleGroup = new AnimationGroup('soleGroup')
        this.toeGuardGroup = new AnimationGroup('toeGuardGroup')
        this.lacesGroup = new AnimationGroup('lacesGroup')
    }
    ...
    resetAllAnimationGroups() {
        ...
        this.swooshLeftGroup.reset()
        this.soleGroup.reset()
        this.toeGuardGroup.reset()
        this.lacesGroup.reset()
    }
    ...
    animateSwooshLeft() {
        /* Animates the 'swoosh_left' mesh in the z position.
         */
        this.sneaker.then((result) => {
            const swooshLeft = this.scene.getMeshByName('swoosh_left')
            ...
            this.swooshLeftGroup.addTargetedAnimation(this.animatePositionZ, swooshLeft)

            this.swooshLeftGroup.play()
        })
    }
